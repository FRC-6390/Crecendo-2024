...
public interface Constants {
    ...
    public interface DRIVETRAIN{
        ...
        SwerveModuleConfig FRONT_LEFT_MODULE_CONFIG = new SwerveModuleConfig(FRONT_LEFT_DRIVE_RECORD, FRONT_LEFT_ROTATION_RECORD, FRONT_LEFT_ENCODER, FRONT_LEFT_OFFSET, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.ROTATION_GEAR_RATIO);
        SwerveModuleConfig FRONT_RIGHT_MODULE_CONFIG = new SwerveModuleConfig(FRONT_RIGHT_DRIVE_RECORD, FRONT_RIGHT_ROTATION_RECORD, FRONT_RIGHT_ENCODER, FRONT_RIGHT_OFFSET, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.ROTATION_GEAR_RATIO);
        SwerveModuleConfig BACK_LEFT_MODULE_CONFIG = new SwerveModuleConfig(BACK_LEFT_DRIVE_RECORD, BACK_LEFT_ROTATION_RECORD, REAR_LEFT_ENCODER, BACK_LEFT_OFFSET, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.ROTATION_GEAR_RATIO);
        SwerveModuleConfig BACK_RIGHT_MODULE_CONFIG = new SwerveModuleConfig(BACK_RIGHT_DRIVE_RECORD, BACK_RIGHT_ROTATION_RECORD, REAR_RIGHT_ENCODER, BACK_RIGHT_OFFSET, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.ROTATION_GEAR_RATIO);
