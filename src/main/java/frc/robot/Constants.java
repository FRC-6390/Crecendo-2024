...
public interface Constants {
    ...
    public interface DRIVETRAIN{
        ...
        SwerveModuleConfig FRONT_LEFT_MODULE_CONFIG = new SwerveModuleConfig(FRONT_LEFT_DRIVE, false, FRONT_LEFT_STEER, false, FRONT_LEFT_ENCODER, FRONT_LEFT_OFFSET, CANBUS, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.DRIVE_ENCODER_CONVERSION_METERS,SWERVEMODULE.MAX_SPEED_METERS_PER_SECOND);
        SwerveModuleConfig FRONT_RIGHT_MODULE_CONFIG = new SwerveModuleConfig(FRONT_RIGHT_DRIVE, false, FRONT_RIGHT_STEER, false, FRONT_RIGHT_ENCODER, FRONT_RIGHT_OFFSET, CANBUS, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.DRIVE_ENCODER_CONVERSION_METERS,SWERVEMODULE.MAX_SPEED_METERS_PER_SECOND);
        SwerveModuleConfig BACK_LEFT_MODULE_CONFIG = new SwerveModuleConfig(REAR_LEFT_DRIVE, false, REAR_LEFT_STEER, false, REAR_LEFT_ENCODER, BACK_LEFT_OFFSET, CANBUS, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.DRIVE_ENCODER_CONVERSION_METERS,SWERVEMODULE.MAX_SPEED_METERS_PER_SECOND);
        SwerveModuleConfig BACK_RIGHT_MODULE_CONFIG = new SwerveModuleConfig(REAR_RIGHT_DRIVE, false, REAR_RIGHT_STEER, false, REAR_RIGHT_ENCODER, BACK_RIGHT_OFFSET, CANBUS, SWERVEMODULE.ROTATION_PID, SWERVEMODULE.DRIVE_ENCODER_CONVERSION_METERS,SWERVEMODULE.MAX_SPEED_METERS_PER_SECOND);
